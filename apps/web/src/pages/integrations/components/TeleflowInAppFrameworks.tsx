...
import { colors, Text, ReactLogo, AngularLogo, JavaScriptLogo, VueLogo, IframeLogo } from '@teleflow/design-system';
import { UTM_CAMPAIGN_QUERY_PARAM } from '@teleflow/shared';
...
const frameworks = [
  ...
  { icon: AngularLogo, name: 'Angular', frameworkEnum: FrameworkEnum.ANGULAR },
  {
    icon: JavaScriptLogo,
    name: 'Web Component',
    href: `https://docs.teleflow.khulnasoft.com/notification-center/client/web-component${UTM_CAMPAIGN_QUERY_PARAM}`,
  },
  {
    icon: JavaScriptLogo,
    name: 'Headless',
    href: `https://docs.teleflow.khulnasoft.com/notification-center/client/headless/get-started${UTM_CAMPAIGN_QUERY_PARAM}`,
  },
