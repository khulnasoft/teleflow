...
export const chatProviders: IProviderConfig[] = [
  {
    ...
    docReference: 'https://docs.teleflow.co/channels/chat/slack',
  ...
  },
  {
    ...
    docReference: 'https://docs.teleflow.co/channels/chat/discord',
  ...
  },
  {
    ...
    channel: ChannelTypeEnum.CHAT,
    credentials: [] as IConfigCredentials[],
    docReference: 'https://docs.teleflow.co/channels/chat/msteams',
